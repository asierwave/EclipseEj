...
public class ReparacionComponenteDAO {
    ...
    /**
     * Inserta un componente en una reparación y descuenta stock si no es reutilizado.
     ...
     */
    public void insertar(ReparacionComponente rc) throws SQLException {
        String sqlInsert = "INSERT INTO Reparacion_componente " +
                ...
                "VALUES (?, ?, ?, ?, ?, ?, ?)";
        String sqlStock = "UPDATE Componente SET STOCK = STOCK - 1 WHERE ID_COM = ?";
