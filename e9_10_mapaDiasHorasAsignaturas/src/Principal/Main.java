...
public class Main {
	...
	//El orden natural del TreeMap es alfabéticamente (cadenas), numeros (Integer)

	//enum diaSemana{Lunes,Martes,Miercoles,Jueves,Viernes} // Se podría hacer tambien con enum. El enum, según vas añadiendo los valores, designan el orden
	...
	public static void main(String[] args) 
	{
		...
		TreeMap<TramoHorario,String> horario = new TreeMap<>(); //Metemos un valor K, y nos devuelve un valor V, ambos String
		...
		{
			System.out.println("Dia: "+item.getKey()+"->"+item.getValue()); //Accedemos al dia de la semana y a la asignatura
			//No saldrán ordenados porque en un mapa se guardan en posiciones aleatorias. Tampoco admite duplicados para un mismo Key.
